 ...
 *
 * Return: The returns integer length of string
 */
int _strlen(char *s)
{
	int j = 0;
...
/**
 * _strcat - This is concatenates two strings
 * @dest: the destination buffer of this project
 * @src: this is the source buffer
 *
 * Return: This is a pointer to destination buffer
 */
